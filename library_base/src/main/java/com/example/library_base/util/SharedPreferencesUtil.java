...
import com.example.library_base.config.StringKey;
...
public class SharedPreferencesUtil {
    ...
    public static void init(Context context, int mode) {
        ...
        prefsUtil.prefs = prefsUtil.context.getSharedPreferences(StringKey.TRUNK, mode);
    ...
    public boolean isFirstRun(Context mContext) {
        String key = "extra_first_run_" + AppUtils.getAppVersionCode (mContext);
        return prefsUtil.getBoolean ( key, true);
    }

    public void setFirstRun(Context mContext, boolean isFirstRun) {
        String key = "extra_first_run_" + AppUtils.getAppVersionCode (mContext);
        prefsUtil.putBoolean (key, isFirstRun);
    }

    public boolean isButtonVisiable(Context mContext) {
        String key = "ButtonVisiable" + AppUtils.getAppVersionCode (mContext);
        return prefsUtil.getBoolean ( key, true);
    }

    public void setButtonVisiable(Context mContext, boolean isFirstRun) {
        String key = "ButtonVisiable" + AppUtils.getAppVersionCode (mContext);
        prefsUtil.putBoolean (key, isFirstRun);
    }
